...
{
    static Script _dialogic = GD.Load<Script>("res://addons/dialogic/Other/DialogicClass.gd");
    const String DEFAULT_DIALOG_RESOURCE = "res://addons/dialogic/Nodes/DialogNode.tscn";
